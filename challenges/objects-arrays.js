...
console.log(`T-Rex weighs: ${tyrannosaurus.length}`);

// What was the diet of a velociraptor?
console.log(`Velociraptor diet: ${velociraptor.diet}`);

// How long was a stegosaurus?
console.log(`Stegasoraus length: ${stegosaurus.length}`);

// What time period did tyrannosaurus live in?
console.log(`T-Rex time period: ${tyrannosaurus.period}`);
...
const uni = [];
graduates.forEach(function(e) {
  if (e.university.toLowerCase().indexOf("uni") >= 0) {
